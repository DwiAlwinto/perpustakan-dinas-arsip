...
trait Mixin
{
    ...
    /**
     * Macro registration (must be implemented by the using class).
     *
     * @param string $name
     * @param callable $macro
     */
    abstract public static function macro($name, $macro);

    /**
     * Cast method (must be implemented by the using class).
     *
     * @param string $className
     */
    abstract public function cast(string $className);
    ...
    private static function loadMixinTrait($trait)
    {
        ...
        foreach (self::getMixableMethods($context) as $name) {
            ...
            static::macro($name, function () use ($closureBase, $className) {
                $downContext = static::context();
                $context = $downContext ? $downContext->cast($className) : new $className();
